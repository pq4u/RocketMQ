...
> **Ostrzeżenie:** domyślny TLS chroni transmisję, ale nie uwierzytelnia klienta. Opcjonalne mTLS dodaje uwierzytelnienie certyfikatu, a osobno włączana allowlista rozdziela globalne lub ograniczone do nazw exchange/kolejek role Publish, Consume i Admin.
...
Aby wymagać certyfikatów klientów i opcjonalnie ograniczyć operacje oraz zasoby, wykonaj instrukcję [Skonfiguruj wzajemne TLS](skonfiguruj-mtls.md). Po włączeniu mTLS nawet lokalny endpoint HTTP jest zabroniony.
